    ...
    >
      ...
      <section className="bg-white w-full flex items-center justify-center flex-col">
        ...
        <motion.div
          ...
          className="flex  w-full  sm:flex-row flex-col mt-20 sm:gap-20 items-center  justify-center"
        >
          <section className="sm:w-[40%]  w-full justify-center  flex items-center sm:items-start  sm:justify-end  ">
            <img
          ...
          <section className="flex sm:w-[50%] sm:gap-3  flex-col gap-3 items-center sm:items-start justify-center">
